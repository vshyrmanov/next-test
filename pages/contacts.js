...
const Contacts = () => {
	return (
		<>
			<Head>
				<title>{`Контакты | Гидрошпонки деформационных и рабочих швов`}</title>
				...
				<meta property="og:title" content={`Контакты | Гидрошпонки деформационных и рабочих швов`} />
			...
			<div className={styles.product_settings}>
				<div className={styles.description}>
					<p>Адрес нашего офиса (производства): город Киев
						Наш телефон: +38(067) 8888-5-08
						Email: info@gidra.com.ua</p>
				</div>
			</div>
		</>
	);
